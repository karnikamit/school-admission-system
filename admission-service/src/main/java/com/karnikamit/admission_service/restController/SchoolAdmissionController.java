package com.karnikamit.admission_service.restController;

import com.karnikamit.admission_service.models.AdmissionRequest;
import com.karnikamit.admission_service.models.ApiResponse;
import com.karnikamit.admission_service.repositories.AdmissionRepository;
...
public class SchoolAdmissionController {
    ...
    public ResponseEntity<ApiResponse<String>> handleAdmissionRequest(@RequestBody AdmissionRequest admissionRequest) {
        ...
        try{
            ...
            kafkaTemplate.send(KAFKA_TOPIC, savedRequest.getId().toString(), savedRequest);
